...
typedef enum {
    ...
    PETSONA_TEXT_MODELS = 17,
    PETSONA_TEXT_BUBBLE_TIMING = 18
} PetsonaTextField;
...
typedef enum {
    ...
    PETSONA_COMMAND_UPDATE_MEMORY_FACT = 37,
    PETSONA_COMMAND_CLEAR_MEMORY_SCOPE = 38,
    PETSONA_COMMAND_EXPORT_MEMORY = 39,
    PETSONA_COMMAND_IMPORT_MEMORY = 40,
    PETSONA_COMMAND_LIST_MODELS = 41,
    PETSONA_COMMAND_RESET_PERSONA = 42,
    PETSONA_COMMAND_SET_BUBBLE_PAUSED = 43
} PetsonaCommandKind;
