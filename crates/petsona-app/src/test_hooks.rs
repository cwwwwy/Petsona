...
pub struct TestStatus {
    ...
    pub conversation_window_created: bool,
    ...
    pub native_menu_checked_pet: Option<String>,
    pub gaze_side: i8,
    ...
    pub bubble_transitions_disabled: bool,
    pub style_reapply_count: u64,
    pub autostart_supported: bool,
    pub autostart_enabled: bool,
    pub gravity_enabled: bool,
    pub gravity_falling: bool,
    pub gravity_grounded: bool,
    pub gravity_velocity: f64,
    pub gravity_landings: u64,
    pub monitor_count: u32,
    pub window_within_work_area: bool,
...
impl Default for TestStatus {
    fn default() -> Self {
        Self {
            ...
            bubble_transitions_disabled: false,
